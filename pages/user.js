                ...
                <div className={styleUser.body}>
                    ...
                    <div className={styleUser.points}>
                        ...
                        <div>
                            ...
                            {user.hasDrown && <h5>{user.directPoint_H}</h5>}
                            <h5>{user.directPoint}</h5>
                        </div>
                        <div>
                            ...
                            {user.hasDrown && <h5>{user.indirectPoint_H}</h5>}
                            <h5>{user.indirectPoint}</h5>
                        </div>
                        <div>
                            ...
                            {user.hasDrown && <h5>{user.totalCash_H}</h5>}
